      ...
      <Cards>
        ...
        <Slide direction="up">
          <Card
            Icon={FiCodesandbox}
            title={"App Developer"}
            disc={`In the world full of Apps, Come Let's create another dimension of Applications, just ping me with your needs and detail info about the world you want!!`}
          />
        </Slide>
